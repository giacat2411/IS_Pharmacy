                        ...
                        if ((+(new Date(x.start_time))) < (+(new Date()))) {
                            return (
                                <div class= 'dung-tachdiv'>
                                    <h2>ID: {x.id}</h2>
                                    <h4 class='dung-benhnhan'>Bệnh nhân: {this.state.system_user[0].lastname+this.state.system_user[0].firstname}</h4>
                                    <div class='dung-thongtin'>
                                        <p>Ngày sinh: {this.state.system_user[0].dateofbirth}</p>
